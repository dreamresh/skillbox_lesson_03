...
speed = int(input('Введите значение скорости, км/ч: '))
time = int(input('Введите время пути, ч: '))
road = speed * time
ring = road // 115
punkt = road - (115 * ring)
print(road, 'км пройдено всего.', ring, 'кругов завершено.', 'Остановка произведена на', punkt, 'километре кольца.')